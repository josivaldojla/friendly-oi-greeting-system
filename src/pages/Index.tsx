...
const Index = () => {
  console.log("Index: Componente iniciando");
  
  const { user, isAdmin, loading } = useAuth();

  console.log("Index: Estado atual - User:", user?.email || 'null', "Loading:", loading, "IsAdmin:", isAdmin);
  ...
  const renderContent = () => {
    try {
      ...
      console.error("Index: Erro ao renderizar conteúdo:", error);
      return (
  ...
  console.log("Index: Retornando conteúdo renderizado");
